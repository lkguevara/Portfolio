...
const Footer = () => {
  return (
    <>
        <footer className="bg-[#1a1a1a] border-t border-orange/20">
        <div className="max-w-6xl mx-auto px-6 py-12">
            ...
            >
                ...
                <span className="text-3xl font-bold text-orange">LK</span>
            ...
            >
                <h4 className="text-orange font-bold mb-4">Sígueme</h4>
                <div className="flex gap-3">
                <a
                    href="https://github.com/lkguevara"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-white/5 hover:bg-orange rounded-lg flex items-center justify-center transition-all group"
                    title="GitHub"
                >
                    <svg
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-white/5 hover:bg-purple rounded-lg flex items-center justify-center transition-all group"
                    title="LinkedIn"
                >
                    <svg
                    className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors"
